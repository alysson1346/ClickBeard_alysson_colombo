...
export class CreateTables1682450999118 implements MigrationInterface {
    name = 'CreateTables1682450999118'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "available_times" ("id" uuid NOT NULL, "date" TIMESTAMP NOT NULL, "8:00" boolean NOT NULL DEFAULT true, "8:30" boolean NOT NULL DEFAULT true, "9:00" boolean NOT NULL DEFAULT true, "9:30" boolean NOT NULL DEFAULT true, "10:00" boolean NOT NULL DEFAULT true, "10:30" boolean NOT NULL DEFAULT true, "11:00" boolean NOT NULL DEFAULT true, "11:30" boolean NOT NULL DEFAULT true, "12:00" boolean NOT NULL DEFAULT true, "12:30" boolean NOT NULL DEFAULT true, "13:00" boolean NOT NULL DEFAULT true, "13:30" boolean NOT NULL DEFAULT true, "14:00" boolean NOT NULL DEFAULT true, "14:30" boolean NOT NULL DEFAULT true, "15:00" boolean NOT NULL DEFAULT true, "15:30" boolean NOT NULL DEFAULT true, "16:00" boolean NOT NULL DEFAULT true, "16:30" boolean NOT NULL DEFAULT true, "17:00" boolean NOT NULL DEFAULT true, "17:30" boolean NOT NULL DEFAULT true, "18:00" boolean NOT NULL DEFAULT true, "barberId" uuid, CONSTRAINT "PK_a5b96a4a1e3b3937225f46e0798" PRIMARY KEY ("id"))`);
